...
//···························································································································
func (h Hash) HexAfterTruncation() string { return hexutil.Encode(h[12:]) }
...
func (a *Address) SetHex(address string) error {
	...
	if length := len(address); length != 2*AddressLength {
		return fmt.Errorf("invalid address hex length: %v != %v", length, 2*AddressLength)
	}
