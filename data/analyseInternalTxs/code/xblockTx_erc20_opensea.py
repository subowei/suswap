...
def getTxsTable():
    ...
    txMap={}
    with open("../data/csv/erc20/opensea/OpenSea.csv") as fOld:
    ...
    # 输出
    print("output")
    f = open("../data/csv/erc20/opensea/txsDetail.csv",'w')
    writer = csv.writer(f)
...
def addFlashbots():
    ...
    fNew = open("../data/csv/erc20/opensea/txsDetail_flashbots.csv",'w')
    writer = csv.writer(fNew)
    with open("../data/csv/erc20/opensea/txsDetail.csv") as fOld:
        reader = csv.reader(fOld)
        header_row=next(reader)
...
def getBlocksTable():
    ...
    with open("../data/csv/erc20/opensea/txsDetail_flashbots.csv") as f:
        reader = csv.reader(f)
        header_row=next(reader)
        i=0
        for row in reader:
    ...
    # output
    print("output")
    f = open("../data/csv/erc20/opensea/blockData_onlyFlashbots.csv",'w')
    writer = csv.writer(f)
